...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('plugins/leaflet-measure/leaflet-measure.css') ?>">
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <script src="<?= base_url('plugins/leaflet-measure/leaflet-measure.js') ?>"></script>
    <!-- Terraformer -->
    ...
    <script>
        /* Initial Map */
        var map = L.map("map").setView([-7.791003107369224, 110.36969390538876], 10); 
        /* Tile Basemap */
