...
<head>
  ...
  <title>Tabel Data Rumah Sakit</title>
...
<body>
  <nav class="navbar navbar-expand-lg bg-dark fixed-top" data-bs-theme="dark">
    <div class="container-fluid">
      <a class="navbar-brand" href="#">Find Hospital</a>
  ...
  <div class="container my-4">
    ...
    <div class="card">
      <div class="card-header">
        <h2><i class="fa-solid fa-circle-plus"></i> Tabel Data Rumah Sakit</h2>
      </div>
      <div class="card-body">
            ...
            foreach ($dataobjek as $d) : ?>
              <tr>
                ...
                <td class="text-center">
                  <a class="btn btn-warning" href="<?= base_url('home/edit_data/') . '/' . $d['id'] ?>" role="button"><i class="fa-solid fa-pen-to-square"></i></a>
